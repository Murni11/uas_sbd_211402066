...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2022 at 08:05 AM
...
--
-- Stand-in structure for view `211402066`
-- (See below for the actual view)
--
CREATE TABLE `211402066` (
`Task id` char(36)
,`Nama Task` varchar(255)
,`Status` enum('Pending','Process','Finished','Canceled')
,`Kategori Indikator` varchar(255)
,`Prioritas` int(11)
,`Creator ID` varchar(255)
...
--
DROP TABLE IF EXISTS `211402066`;
